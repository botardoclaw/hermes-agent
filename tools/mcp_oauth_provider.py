            ...
            try:
                ...
                while True:
                    ...
                    if out is not request:
                        ...
                        out = prepare_oauth_flow_request(out, server_url=getattr(self.context, "server_url", None), user_agent=getattr(self, "_hermes_token_user_agent", None), context=self.context)
